<template>
    <el-dialog v-model="visible" :title="titleMap[mode]" :width="500" destroy-on-close @closed="$emit('closed')">
        <el-form ref="dialogForm" :disabled="mode === 'show'" :model="form" :rules="rules" label-position="left" label-width="6.25rem">
            ...
            <el-form-item label="备注" prop="remark">
                <el-input v-model="formNaNpxark" clearable type="textarea"></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
