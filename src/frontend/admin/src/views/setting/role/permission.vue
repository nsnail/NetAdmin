                ...
                <el-form label-position="left" label-width="100px">
                    ...
                    <el-form-item v-show="data.dataType === '5'" label="选择部门">
                        <div class="treeMain" style="width: 100%">
                            <el-tree ref="dept" :data="data.list" :props="data.props" node-key="id" show-checkbox></el-tree>
                        </div>
                    </el-form-item>
                    <el-form-item v-show="data.dataType === '6'" label="规则值">
                        <el-input v-model="data.rule" :rows="6" clearable placeholder="请输入自定义规则代码" type="textarea"></el-input>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
