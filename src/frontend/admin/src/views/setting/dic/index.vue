<template>
        ...
        <el-aside v-loading="showDicloading" width="300px">
            <el-container>
                ...
                <el-footer style="height: 51px">
                    <el-button icon="el-icon-plus" size="small" style="width: 100%" type="primary" @click="addDic">字典分类</el-button>
                </el-footer>
            </el-container>
        </el-aside>
    ...
    <list-dialog v-if="dialog.list" ref="listDialog" @closed="dialog.list = false" @success="handleListSuccess"></list-dialog>
</template>
