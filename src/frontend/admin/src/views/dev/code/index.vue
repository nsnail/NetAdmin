                ...
                <el-card :body-style="{ padding: '0px' }" shadow="hover">
                    <div class="code-item">
                        ...
                        <div class="title">
                            <h2>生成前端代码</h2>
                            <p>
                                <el-button @click="generateJsCode()"
                                    >生成
                                </el-button>
                            </p>
                        </div>
                ...
                <el-card :body-style="{ padding: '0px' }" shadow="hover">
                    <div class="code-item">
                        ...
                        <div class="title">
                            ...
                            <p>
                                <el-input
                                    v-model="formCs.moduleName"
                                    placeholder="模块名称"
                                ></el-input>
                            </p>
                            <p>
                                <el-input
                                    v-model="formCs.moduleRemark"
                                    placeholder="模块说明"
                                ></el-input>
                            </p>
                            <p>
                                <el-button @click="generateCsCode()"
                                    >生成
                                </el-button>
                            </p>
                        </div>
                    ...
                    <div class="code-item">
                        ...
                        <div class="title">
                            ...
                            <p>
                                <el-row>
                                    <el-col :span="12">
                                        <el-button @click="generateIconCode()"
                                            >生成
                                        </el-button>
                                    </el-col>
                                    <el-col :span="12">
