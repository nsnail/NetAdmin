<template>
            ...
            <scTable ref="table" :apiObj="list.apiObj" row-key="id" stripe @selection-change="selectionChange">
                ...
                <el-table-column align="right" fixed="right" label="操作" width="300">
                    <template #default="scope">
                        ...
                        <el-button plain size="small" type="primary" @click="table_edit_page(scope.row)">页面编辑</el-button>
    ...
    <save-dialog v-if="dialog.save" ref="saveDialog" @closed="dialog.save = false" @success="handleSaveSuccess"></save-dialog>
