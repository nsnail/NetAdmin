 ...
 * @LastEditTime: 2023-03-19 11:41:16
-->
...
<template>
        ...
        <el-row :gutter="15">
            <el-col :lg="12">
                <el-card shadow="never">
                    <el-alert style="margin-bottom: 20px" title="试试右键表格行看看. 支持多级菜单, 动态菜单等等等..." type="success"></el-alert>
    ...
    <sc-contextmenu ref="contextmenu" @command="handleCommand" @visible-change="visibleChange">
        ...
        <sc-contextmenu-item command="b" icon="el-icon-refresh" suffix="Ctrl+R" title="重新加载(R)"></sc-contextmenu-item>
