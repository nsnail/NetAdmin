 ...
 * @LastEditTime: 2023-03-19 12:02:06
-->
        ...
        <el-row :gutter="15">
            <el-col :lg="14">
                <el-card shadow="never">
                    <sc-cropper ref="cropper" :aspectRatio="aspectRatio" :compress="compress" :src="cropperImg"></sc-cropper>
                </el-card>
            ...
            <el-col :lg="10">
                <el-card header="已内置剪裁的上传组件" shadow="never">
                    ...
                    <sc-upload v-model="uploadImg" :aspectRatio="1 / 1" :compress="1" :cropper="true" title="开启剪裁"></sc-upload>
                </el-card>
            </el-col>
        </el-row>
    </el-main>
...
export default {
    ...
    data() {
        return {
            cropperImg: '@/assets/img/avatar.jpg',
            compress: 0.5,
            aspectRatio: 0,
            uploadImg: '',
            imgData: '',
