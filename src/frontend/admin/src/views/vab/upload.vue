    ...
    <el-main>
        ...
        <el-card header="单图像示例" shadow="never">
            <el-space :size="8" wrap>
                ...
                <sc-upload v-model="fileurl5" :apiObj="uploadApi" :on-success="success" :width="220" accept="image/jpg,image/png">
                ...
                <sc-upload v-model="fileurl7" :aspectRatio="1 / 1" :compress="1" :cropper="true" title="开启剪裁"></sc-upload>
            </el-space>
        </el-card>
