<template>
    <el-form class="login-content-form" size="large">
        <el-form-item class="login-animation1">
            <el-input v-model="state.ruleForm.account" :placeholder="$t('message.account.accountPlaceholder1')" autocomplete="off" clearable text>
                <template #prefix>
...
const onSignIn = async () => {
    var res = await user.loginByPwd.post(state.ruleForm);
