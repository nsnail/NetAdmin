<template>
    <el-dialog v-model="visible" :title="titleMap[mode]" :width="500" destroy-on-close @closed="$emit('closed')">
                ...
                <el-collapse-item name="1" title="用户注册设置">
                    <div style="margin:10px">
                        ...
                        <el-form-item label="默认角色" prop="userRegisterRoleId">
                            <el-select v-model="form.userRegisterRoleId" clearable filterable style="width: 100%">
                        ...
                        <el-form-item label="默认岗位" prop="userRegisterPosId">
                            <el-select v-model="form.userRegisterPosId" clearable filterable style="width: 100%">
        ...
        <template #footer>
            ...
            <el-button v-if="mode!=='show'" :loading="isSaving" type="primary" @click="submit()">保 存</el-button>
        </template>
    </el-dialog>
</template>
